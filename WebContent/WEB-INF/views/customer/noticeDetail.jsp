...
<%@page import="com.newlecture.jspprj.dao.mybatis.MyBatisMain"%>
            ...
            <main id="main">
                ...
                <article id="notice-detail" class="space-top-l">
                    ...
                    <p id="button-container" class="space-top text-center">
                        <a id="btn-list" href="notice.htm">목록</a>
                        <a href="noticeEdit.htm?c=${n.code}">수정</a>
                        <a href="noticeDel.htm?c=${n.code}">삭제</a>
                    </p>
                </article>
