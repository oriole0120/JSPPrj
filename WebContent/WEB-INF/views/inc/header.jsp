        ...
        <div class="content-wrapper">
            ...
            <section class="header-item-container">
                ...
                <nav id="member-menu">
                    ...
                    <ul class="clearfix">
                        <li class="member-menu-item"><a class="member-menu-item-text" href="${ctxName}/index.htm">홈</a></li>
                        <li class="member-menu-item">
                        <c:if test="${empty pageContext.request.userPrincipal}">
                        	<a class="member-menu-item-text" href="${ctxName}/joinus/login.htm">로그인</a>
                        </c:if>
                        <c:if test="${not empty pageContext.request.userPrincipal }">
                        	<a class="member-menu-item-text" href="${ctxName}/j_spring_security_logout">로그아웃</a>
                        </c:if>
                        </li>
